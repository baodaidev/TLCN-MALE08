...
train_batches = gen.flow_from_directory("../Data/Train",model.input_shape[1:3],color_mode="grayscale",shuffle=True,seed=1,
                                        batch_size=16)
valid_batches = gen.flow_from_directory("../Data/Valid", model.input_shape[1:3],color_mode="grayscale", shuffle=True,seed=1,
                                        batch_size=16)
...
# Save the model
model.save('D:\Model\DAI\lungdetection-rate-0001.h5')
